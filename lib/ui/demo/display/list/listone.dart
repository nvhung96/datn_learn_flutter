...
class DisplayListOne extends StatefulWidget {
  @override
  _DisplayListOneState createState() => _DisplayListOneState();
}

class _DisplayListOneState extends State<DisplayListOne> {
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Stack(
            children: <Widget>[
              Container(
                padding: EdgeInsets.only(top: 138.5),
                height: MediaQuery.of(context).size.height,
